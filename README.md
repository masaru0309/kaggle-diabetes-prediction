...
自分の発想が「意味のある名前がつくものしか特徴量にしてはいけない」という既存の勝手な枠に囚われていたことに気づき、今後はより柔軟に特徴量を作成していきたいと考えています。
* [04_failed_hyperparameter_tuning.ipynb](./04_failed_hyperparameter_tuning.ipynb)で過学習が起きた原因について
  * 当該NotebookではさらなるPublic scoreの向上を目指して early_stopping_rounds=200 にして
